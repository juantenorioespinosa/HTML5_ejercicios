...
- tabla_sencilla1.html: Ejercicio 1 - Uso de la etiqueta &lt;caption&gt;.
- tabla_sencilla2.html: Ejercicio 2 - Uso del atributo `border`.

Enunciados:
Réplica de Capturas: Maquetar 2 documentos HTML para que coincidan exactamente con las imágenes de referencia, practicando tablas sencillas.
